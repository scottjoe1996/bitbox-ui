...
import { BitButton as BitButtonElement, defineCustomElement as defineBitButton } from "@bitbox-ui/web/components/bit-button.js";
...
export const BitButton = /*@__PURE__*/ createComponent<BitButtonElement, BitButtonEvents>({
    tagName: 'bit-button',
